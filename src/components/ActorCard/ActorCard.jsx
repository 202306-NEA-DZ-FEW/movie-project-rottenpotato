...
function ActorCard({ person }) {
  ...
  return (
    <Link
      ...
      className="actor-card rounded-lg overflow-hidden shadow-lg w-48 h-72 flex-shrink-0 m-1/4 mr-2 ml-2 mb-2 mt-2 relative transform transition-transform duration-300 ease-in-out hover:scale-105"
    >
